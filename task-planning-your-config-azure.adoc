...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_azure_9101.html["Azure で Cloud Volumes ONTAP がサポートされている構成"^]
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_azure_9101.html["Azure での Cloud Volumes ONTAP のストレージの制限"^]
