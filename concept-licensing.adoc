...
* link:task-set-up-licensing-aws.html["AzureでCloud Volumes ONTAP のライセンスをセットアップする"]
...
* link:task-set-up-licensing-aws.html["Google CloudでCloud Volumes ONTAP のライセンスを設定します"]
