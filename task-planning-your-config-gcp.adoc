...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_gcp_9101.html["GCP の Cloud Volumes ONTAP でサポートされている構成"^]
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_gcp_9101.html["GCP の Cloud Volumes ONTAP でのストレージの制限"^]
